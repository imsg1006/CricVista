...
const Players = () => {
  ...
  className='absolute overflow-hidden 
             ...
             lg:w-[15vw] w-[25vw] 
             lg:top-40 -top-32  /* shifted higher */
...
>
  ...
  />
      ...
      <div className='lg:mt-[45vh]  mt-[40vh]'>
        <h1 className='text-[14vw] text-center  bg-gradient-to-r from-orange-500 via-white to-green-500 bg-clip-text
       text-transparent uppercase leading-[15vw]'>
          Champions <br /> in blue</h1>
        </div>
        <div className='lg:pl-[40%] lg:mt-20 mt-4 p-3'>
          <p className=' lg:text-6xl text-xl leading-tight bg-gradient-to-r from-orange-500 via-white to-green-500 bg-clip-text text-transparent  p-2 m-2  '>Meet the cricketing legends who carried the pride of a billion hearts. Each player journey is a story of passion, resilience, and glory in the Indian jersey.</p>  
        </div>
    </div>
    </div>
    <div className="section2 m-10 h-screen">
       <ExpandableCardDemo/>
     </div>
    </div>
  )
